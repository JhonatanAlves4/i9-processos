...
export default function About() {
  return (
    <section id="About" className="flex h-80vh w-[100vw] px-4 md:px-10">
      <div className="flex flexDiv flex-row md:flex w-full h-full mt-20">
        ...
        <div className="w-full lg:w-2/3 h-full flex flex-col justify-center items-center text-center text-white mt-4 md:mt-14 ">
          <h3 className="font-medium text-[18px] md:text-[28px] lg:text-[30px] ">
            A evolução para seu projeto está aqui
          </h3>
          <h1 className="leading-tight text-[25px] md:text-[35px] lg:text-[40px] max-w-[895px] my-[35px] font-semibold  text-white">
          ...
          <h2 className="text-[18px] md:text-[22px] lg:text-[25px] max-w-[520px]">
